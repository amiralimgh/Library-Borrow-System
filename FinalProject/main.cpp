 ...
 //------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        case 3: //This case gets activated if the user choses opntion number 3
            ...
            try
            {
                ...
                if (accFound == false & accFoundNoBorrow == false) //If the id is invalid this will run
                {
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        case 7: //This case gets activated if the user choses opntion number 7
            cout << "" << endl;
            cout << "----------------------------------------" << endl;
            cout << "Thank you for using library management" << endl;
